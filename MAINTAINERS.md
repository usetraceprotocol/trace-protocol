...
This document lists the core maintainers of the Trace Protocol project and their areas of responsibility.
...
### @0xverifier
**Role:** Ethereum/Rust Specialist
**Focus:** On-chain contracts, Foundry development, Ethereum integration
**Responsibilities:**
- Foundry contract development (contracts/trace-attestation)
- On-chain attestation logic and account structures
- Ethereum RPC integration and transaction parsing
...
from @tracecore plus at least one other maintainer.

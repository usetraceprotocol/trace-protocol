...
If you discover a security vulnerability in Trace Protocol, please report it responsibly.
...
- **On-chain contract** (contracts/trace-attestation): Account validation, access control,

...
The Trace Protocol classifier uses 47 behavioral features extracted from on-chain
...
Features describing which Ethereum smart contracts the agent interacts with and how.
...
| 16 | prog_cpi_depth_mean | Mean delegatecall depth per transaction |
...
| # | Feature | Description |
|---|---------|-------------|
| 21 | bal_mean_fee | Mean transaction fee in wei |
...
| 25 | bal_token_transfer_count | Total number of ERC-20 transfer instructions |

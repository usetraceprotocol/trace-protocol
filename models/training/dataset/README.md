...
This directory contains the labeled dataset used for training the Trace Protocol
agent classifier.
...
|--------|------|-------------|
| address | string | Ethereum public key of the agent |
...
| prog_cpi_depth_mean | float32 | Mean delegatecall depth |
...
| bal_mean_fee | float32 | Mean transaction fee (wei) |
...
| bal_token_transfer_count | float32 | Number of ERC-20 transfers |

"""
Trace Protocol - Agent Classifier Training Script

Trains a neural network to classify Ethereum agents as AUTONOMOUS, HYBRID, or HUMAN
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train Trace Protocol agent classifier")
    parser.add_argument(

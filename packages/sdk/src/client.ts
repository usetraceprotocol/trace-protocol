...
const DEFAULT_CONFIG: Required<TraceClientConfig> = {
...
/**
 * TraceClient provides a typed interface for interacting with the
 * Trace Protocol API. It supports single verdict lookups, batch
 * queries, and real-time WebSocket subscriptions.
 */
export class TraceClient {
  private readonly config: Required<TraceClientConfig>;
  ...
  /**
   * Get the verdict for a single Ethereum address.
   */

...
import type { ClassificationResult, AgentClass } from "@trace-protocol/classifier";
import { FEATURE_NAMES } from "@trace-protocol/classifier";
import type { AgentSignal } from "@trace-protocol/scanner";
import {
  Verdict,
  type VerdictResult,
  type VerdictReason,
...
const logger = pino({ name: "trace-verdict-engine" });
